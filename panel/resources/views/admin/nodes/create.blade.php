...
<div class="max-w-3xl mx-auto">
    <div class="bg-slate-800 shadow-xl rounded-xl border border-slate-700 overflow-hidden p-6">
        <form action="{{ route('admin.nodes.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                ...
                <div class="sm:col-span-4">
                    ...
                    <div class="mt-1">
                        <input type="text" name="fqdn" id="fqdn" placeholder="node1.example.com" required class="block w-full rounded-md border-0 bg-slate-900 py-2 text-white shadow-sm ring-1 ring-inset ring-slate-700 focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm sm:leading-6">
                    </div>
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-1">
                        <input type="number" name="memory" id="memory" required class="block w-full rounded-md border-0 bg-slate-900 py-2 text-white shadow-sm ring-1 ring-inset ring-slate-700 focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-1">
                        <input type="number" name="disk" id="disk" required class="block w-full rounded-md border-0 bg-slate-900 py-2 text-white shadow-sm ring-1 ring-inset ring-slate-700 focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm sm:leading-6">
                    </div>
                </div>
                 ...
                 <div class="sm:col-span-3">
                    ...
                    <div class="mt-1">
                        <input type="number" name="daemon_listen" id="daemon_listen" value="8080" required class="block w-full rounded-md border-0 bg-slate-900 py-2 text-white shadow-sm ring-1 ring-inset ring-slate-700 focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm sm:leading-6">
                    </div>
                </div>
                 ...
                 <div class="sm:col-span-3">
                    ...
                    <div class="mt-1">
                        <input type="number" name="daemon_sftp" id="daemon_sftp" value="2022" required class="block w-full rounded-md border-0 bg-slate-900 py-2 text-white shadow-sm ring-1 ring-inset ring-slate-700 focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div class="sm:col-span-6">
                    <div class="relative flex items-start">
                        <div class="flex h-6 items-center">
                            <input id="public" name="public" type="checkbox" value="1" checked class="h-4 w-4 rounded border-slate-700 bg-slate-900 text-blue-600 focus:ring-blue-600 focus:ring-offset-slate-900">
                        </div>
            ...
            <div class="flex justify-end pt-4 border-t border-slate-700 mt-6">
                <a href="{{ route('admin.nodes.index') }}" class="mr-3 px-4 py-2 text-sm font-medium text-slate-300 hover:text-white">Cancel</a>
