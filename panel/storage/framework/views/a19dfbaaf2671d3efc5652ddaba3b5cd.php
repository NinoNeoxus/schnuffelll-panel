...
<div class="space-y-6">
            ...
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        ...
                        <dd class="mt-1 text-2xl font-bold tracking-tight text-white"><?php echo e($stats['servers']); ?></dd>
                    </dl>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        ...
                        <dd class="mt-1 text-2xl font-bold tracking-tight text-white"><?php echo e($stats['servers_online']); ?></dd>
                    </dl>
                </div>
            </div>
        </div>
             ...
             <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        ...
                        <dd class="mt-1 text-2xl font-bold tracking-tight text-white"><?php echo e($stats['nodes']); ?></dd>
                    </dl>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center">
               ...
               <div class="ml-5 w-0 flex-1">
                   <dl>
                       ...
                       <dd class="mt-1 text-2xl font-bold tracking-tight text-white"><?php echo e($stats['users']); ?></dd>
                   </dl>
               </div>
           </div>
       </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
        ...
        <div class="bg-slate-800 rounded-xl shadow-xl border border-slate-700 overflow-hidden">
            ...
            <div class="p-6">
                <?php if($recentServers->isEmpty()): ?>
                    <p class="text-slate-400 text-sm">No servers deployed yet.</p>
                <?php else: ?>
                    <div class="flow-root">
                        <ul role="list" class="-my-5 divide-y divide-slate-700">
                            <?php $__currentLoopData = $recentServers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $server): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="py-4">
                                <div class="flex items-center space-x-4">
                                    <div class="flex-shrink-0">
                                        <div class="h-8 w-8 rounded-full bg-slate-700 flex items-center justify-center">
                                            <span class="text-xs font-bold text-white"><?php echo e(substr($server->name, 0, 2)); ?></span>
                                        </div>
                                    </div>
                                    <div class="min-w-0 flex-1">
                                        <p class="truncate text-sm font-medium text-white"><?php echo e($server->name); ?></p>
                                        <p class="truncate text-xs text-slate-400"><?php echo e($server->egg->name); ?> &bull; <?php echo e($server->node->name); ?></p>
                                    </div>
                                    <div>
                                        <span class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium 
                                            <?php echo e($server->status == 'running' ? 'bg-emerald-500/10 text-emerald-400' : 'bg-amber-500/10 text-amber-400'); ?>">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-1">
                                <span class="text-sm font-medium text-slate-200"><?php echo e($node->name); ?></span>
                                <span class="text-xs text-slate-400"><?php echo e($node->servers_count); ?> servers</span>
                            </div>
