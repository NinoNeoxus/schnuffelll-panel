    ...
    <div class="bg-slate-800 shadow-xl rounded-xl border border-slate-700 overflow-hidden">
        ...
        <div class="p-6 space-y-8">
            <?php if(session('success')): ?>
                <div class="rounded-md bg-emerald-500/10 p-4 border border-emerald-500/20">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm font-medium text-emerald-400"><?php echo e(session('success')); ?></p>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <?php if($errors->any()): ?>
                 <div class="rounded-md bg-red-500/10 p-4 border border-red-500/20">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm font-medium text-red-400"><?php echo e($errors->first()); ?></p>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <div class="flex items-center justify-between">
                ...
                <div>
                     <form action="<?php echo e(route('admin.settings.update')); ?>" method="POST" onsubmit="return confirm('Are you sure you want to update the panel?');">
                        <?php echo csrf_field(); ?>
            ...
            <div class="border-t border-slate-700 pt-6">
                ...
                <dl class="divide-y divide-slate-700">
                    ...
                    <div class="py-3 flex justify-between">
                        ...
                        <dd class="text-sm text-slate-400 font-mono"><?php echo e(phpversion()); ?></dd>
                    </div>
                    <div class="py-3 flex justify-between">
                         <dt class="text-sm font-medium text-slate-300">Environment</dt>
                         <dd class="text-sm text-slate-400"><?php echo e(app()->environment()); ?></dd>
                    </div>
                    <div class="py-3 flex justify-between">
                         <dt class="text-sm font-medium text-slate-300">Debug Mode</dt>
                         <dd class="text-sm <?php echo e(config('app.debug') ? 'text-red-400' : 'text-emerald-400'); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\panleee\schnuffelll\panel\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>